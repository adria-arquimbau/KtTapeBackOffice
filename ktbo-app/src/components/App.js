...
function App({ history }) {
  ...
  return <>
    <Context.Provider value={{ user, setUser, goHome, setGoHome, cat, setCat, articles, setArticles, items, setItems, interruptorItems, setInterruptorItems, betaMessage, setBetaMessage }} >
      <div className="App">
